...
import android.widget.ProgressBar;
import android.widget.Toast;
import com.iit.rakshak.Math.Fft;
...
public class HeartRateProcessNewPhone extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_heart_rate_process_new_phone);
    ...
    private PreviewCallback previewCallback = new PreviewCallback() {
        ...
        public void onPreviewFrame(byte[] data, Camera cam) {
            ...
            if (Beats != 0) { //if beasts were reasonable stop the loop and send HR with the username to results activity and finish this activity
                Intent i = new Intent(HeartRateProcessNewPhone.this, HeartRateResult.class);
